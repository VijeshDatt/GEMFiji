        ...
        [
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("v-card-text", [
                _c("p", { staticClass: "text-justify black--text" }, [
                  _vm._v(
                    "\n          We are a unique family business providing business solutions for organizations to be more efficient, improve performance and provide better results. We work with organizations in every industry in the public and private sectors and of every size from startups to multinationals.\n        "
                  )
                ]),
                _vm._v(" "),
                _c("p", { staticClass: "text-justify black--text" }, [
                  _vm._v(
                    "\n          GEM (Fiji) Limited formerly called Graphics Equipments Limited was established in 1972 with a vision of reaching out to customers and providing business solutions\n        "
                  )
                ])
              ]),
              _vm._v(" "),
                  ...
                  _c(
                    ...
                    [
                      _c(
                        ...
                        [
                          _c("h1", [_vm._v("GEM Office Products")]),
                          _vm._v(" "),
                          _c("p", [
                            _vm._v(
                              "Supplies quality office furniture, equipment, stationery and educational products."
                            )
                          ])
                        ]
                      ),
                      ...
                      _c("v-col", { attrs: { cols: "12", md: "6" } }, [
                        _c("h2", [_vm._v("GEM IT Solutions")]),
                        _vm._v(" "),
                        _c("p", [
                          _vm._v(
                            "Providing IT hardware, software, services, consulting, training, implementation services."
                          )
                        ])
                      ]),
                      _vm._v(" "),
                      _c(
                        ...
                        [
                          _c("h2", [_vm._v("GEM Visual Concepts")]),
                          _vm._v(" "),
                          _c("p", [
                            _vm._v(
                              "Creating innovative design concepts and producing finished signage, promotional and printed items."
                            )
                          ])
                        ]
                      ),
